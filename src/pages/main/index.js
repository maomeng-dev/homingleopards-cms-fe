...
class Logout extends Component {
  ...
  render () {
    return (
      <span className="link-button" onClick={this.onLogoutClick.bind(this)}>
        注销
      </span>
    )
  }
      ...
      <Layout style={{ minHeight: '100vh' }}>
        <Header className="main-header">
          <div className="main-title f-l">
            <Link to="/">
              <Icon type="project" theme="filled"/> 带豹回家官网 - 管理系统
            </Link>
          </div>
          <div className="f-r">
            欢迎访问，
        ...
        <Layout>
          ...
          <Layout style={{ padding: '0 24px 24px' }}>
            ...
            <Footer style={{ textAlign: 'center' }}>
              <Icon type="code" theme="twoTone" twoToneColor="#69c0ff"/> with{' '}
              <Icon type="heart" twoToneColor="#ff7875" theme="twoTone"/> by CFCA-Dev-Team &copy;{' '}
